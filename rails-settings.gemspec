...
Gem::Specification.new do |s|
  ...
  s.files = [".project", ".rvmrc", "MIT-LICENSE", "README.rdoc", "Rakefile", "VERSION", "lib/generators/settings/settings_generator.rb", "lib/generators/settings/templates/migration.rb", "lib/generators/settings/templates/model.rb", "lib/rails-settings.rb", "lib/rails-settings/railtie.rb", "lib/rails-settings/scoped_settings.rb", "lib/rails-settings/settings.rb", "rails-settings.gemspec", "rails/init.rb"]
